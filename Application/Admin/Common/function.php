...
*/
      ...
      'tools' => array('name' => '公众号设置', 'icon'=>'fa-plug', 'sub_menu' => array(
            
			array('name'=>'参数设置','act'=>'index','control'=>'Wechat'),
            array('name'=>'菜单设置','act'=>'menu','control'=>'Wechat'),
            array('name'=>'关键词回复','act'=>'text','control'=>'Wechat'),
