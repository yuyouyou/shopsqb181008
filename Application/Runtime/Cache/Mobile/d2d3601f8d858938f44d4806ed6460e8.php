...
<link rel="stylesheet" type="text/css" href="/Template/mobile/new/Static/css/activity.css">   
...
<div id="J_ItemList">
	<?php if(is_array($prom_list)): foreach($prom_list as $key=>$vo): ?><ul class="single_item info" id="more_element_3">
	  <div class="huodong">
