...
function getAcsClient()
{
    ...
    $accessKeyId = "LTAIl6LdnPsjfhJT"; // AccessKeyId

    $accessKeySecret = "B0kdDMuepUafzIyE4MgTEdjKPwJLUf"; // AccessKeySecret
...
function mysendSms($sender, $code)
{
    ...
    // 必填，设置短信接收号码
    $request->setPhoneNumbers($sender);

    // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
    $request->setSignName("花水木科技");

    // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
    $request->setTemplateCode("SMS_151755582");
